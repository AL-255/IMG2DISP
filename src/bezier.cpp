...
namespace ImGui
{
    ...
    int Bezier(const char *label, float P[5]) {
        ...
        if (ImGui::BeginTable("BezierTable", 2, 0)) {
            ...
            // 4 separate sliders
            // 1-4: P0, P1, P2, P3
            bool p0c = SliderFloat("##P0", &P[0], 0, 1, "%.3f", 1.0f);
            bool p1c = SliderFloat("##P1", &P[1], 0, 1, "%.3f", 1.0f);
            bool p2c = SliderFloat("##P2", &P[2], 0, 1, "%.3f", 1.0f);
            bool p3c = SliderFloat("##P3", &P[3], 0, 1, "%.3f", 1.0f);

            int changed = p0c || p1c || p2c || p3c || reload;
